        ...
        <div className='interview-page'>
            <div className='interview-layout'>
                ...
                <nav className='interview-nav'>
                    <div className="interview-nav__back-wrap">
                        <button onClick={() => navigate('/')} className="interview-nav__back">
                            <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><polyline points="15 18 9 12 15 6"></polyline></svg>
                            <span className="interview-nav__back-text">Back to Home</span>
                        </button>
                    </div>

                    <div className="interview-nav__tabs">
                        ...
                        {NAV_ITEMS.map(item => (
                            ...
                            >
                                ...
                                <span className='interview-nav__label-full'>{item.label}</span>
                                <span className='interview-nav__label-short'>{item.shortLabel}</span>
                            </button>
                        ))}
                    </div>
                    ...
                    <div className="interview-nav__actions">
                        <button
                            ...
                            className='button primary-button interview-nav__btn-download' >
                            ...
                            <span className="interview-nav__btn-text-full">Download Resume</span>
                            <span className="interview-nav__btn-text-short">Resume</span>
                        </button>
                        <button
                            onClick={handleLogoutClick}
                            className='button logout-button interview-nav__btn-logout'
                            title='Logout'>
                            ...
                            <span className="interview-nav__logout-text">Logout</span>
                        </button>
                    </div>
                </nav>
